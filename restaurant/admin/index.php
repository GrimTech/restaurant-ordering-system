...
<!-- //header-ends -->
			...
			<div class="mid-content-top charts-grids">
				<div class="middle-content">
					...
					<div id="owl-demo" class="owl-carousel text-center">
						<div class="item">
							<img class="lazyOwl img-responsive" src="images/slider1.jpg" alt="name">
						</div>
						<div class="item">
	...
	<div class="footer">
       ...
       <?php
        ...
        $bootstrap1school = $bootstrap1.getSchoolName();
        $bootstrap1Type = typeof($bootstrap1);
        var_dump($bootstrap1school);
        var_dump($bootstrap1Type);
    ?> 
    <script>
        class bootstrap {
            let school = "AAUA";
        ...
        let bootstrap1 = new bootstrap,
        bootstrap1School = bootstrap1.getSchoolName(),
        bootstrap1Type = typeof(bootstrap1);
        console.log('leaF');
        console.log(bootstrap1school);
        console.log(bootstrapt1Type);
    </script>
    <a href="https://w3layouts.com/" target="_blank">Jackson</a></p>		
	</div>
    <!--//footer-->
	</div>
